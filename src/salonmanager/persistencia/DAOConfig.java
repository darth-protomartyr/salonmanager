...
public class DAOConfig extends DAO {
    ...
    public void saveConfigActual(boolean wsOpen, int wsId, ArrayList<String> defers, ArrayList<String> mods, ArrayList<Integer> indexes) throws Exception {
        try {
            ...
            String sql1 = "INSERT INTO config_actual(config_open_ws, config_open_ws_id, congif_defer_close_ws, congif_unmod_tabs, config_indexes_buttons)"
    ...
    public void updateIndexes(ArrayList<Integer> indexes, boolean end) throws Exception {
        String stArray = "";
        if (indexes.size() > 0) {
