    ...
    public ArrayList<ItemMonitor> getItemsMonitorOpen() throws Exception {
        try {
            ...
            while (resultado.next()) {
                ...
                Timestamp dateInitIMon = SalonManager.decryptTs(resultado.getString(6));
                boolean cookIMon = SalonManager.decryptBoolean(resultado.getString(7));
                Timestamp dateCookIMon = SalonManager.decryptTs(resultado.getString(8));
                boolean readyIMon = SalonManager.decryptBoolean(resultado.getString(9));
                Timestamp dateReadyIMon = SalonManager.decryptTs(resultado.getString(10));
                boolean otwIMon = SalonManager.decryptBoolean(resultado.getString(11));
                Timestamp dateOtwIMon = SalonManager.decryptTs(resultado.getString(12));
