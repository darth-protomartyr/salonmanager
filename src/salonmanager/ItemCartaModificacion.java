...
public class ItemCartaModificacion extends FrameHalf {
    ...
    public ItemCartaModificacion(ItemCarta ic) throws Exception {
        itemAux= ic;
        sm.addFrame(this);
        item = ic;
        ...
        JPanel panelForm = utiliGraf.panelItemCartaForm(fieldName, comboCaption, areaDescription, fieldCost, fieldPrice, fieldStock, checkTip, captionsDB, itemAux);
